    ...
    <section className="relative min-h-[75vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-10 md:py-14 w-full">
        ...
        >
          ...
          <p className="font-body text-base md:text-lg text-muted-foreground leading-relaxed mb-3 max-w-lg">
            Skip the guesswork. Get a match so good, it becomes their new favourite.
          </p>

          <p className="font-body text-sm text-muted-foreground/80 leading-relaxed mb-8 max-w-lg">
            No second-guessing. Just the perfect scent match in minutes.
          </p>
