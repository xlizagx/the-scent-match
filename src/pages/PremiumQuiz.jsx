    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6">
        ...
        >
          ...
          <p className="font-heading text-xl text-foreground mb-2">Curating your matches...</p>
          <p className="text-sm text-muted-foreground font-heading italic font-normal">Consulting The Scent Match</p>
        </motion.div>
      </div>
    );
  }
